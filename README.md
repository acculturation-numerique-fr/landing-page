...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Visuals-DNVB_Style-ff69b4?style=flat-square" alt="DNVB Style" />
  <img src="https://img.shields.io/badge/Branding-Premium_Pet_Care-000000?style=flat-square" alt="Premium Pet Care" />
...
|---|---|---|
| <img src="docs/IV. Context Engineering/custom_colors.png" width="300" /> | <img src="docs/IV. Context Engineering/custom_effects.png" width="300" /> | <img src="docs/IV. Context Engineering/custom_typography.png" width="300" /> |
...
```mermaid
graph TD
    A[Routeur App.tsx] --> B[Page Index.tsx]
    B --> C[Navbar]
    B --> D[Hero]
    B --> E[ProductGrid]
    B --> F[WhySection]
    ...
    E -- Alimente --> P[Product Card]
    D -- Contexte --> B1[Contexte Stratégique]
```
...
<div align="center">
  <img src="docs/V. Vibecoding/publish.png" alt="Publish Pipeline" width="100%" />
</div>
...
**Démo en ligne** : [**meow-meow-lover.lovable.app**](https://meow-meow-lover.lovable.app/#)
